...
$.extend($.jgrid,{
	...
	cellWidth : function () {
		var $testDiv = $("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable ui-common-table' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'>777777</td></tr></table></div>"),
	...
	return this.each( function() {
		...
		populate = function (npage) {
			if(!ts.grid.hDiv.loading) {
				...
				dt = ts.p.datatype.toLowerCase();/*alert(JSON.stringify($.isFunction(ts.p.serializeGridData)? ts.p.serializeGridData.call(ts,ts.p.postData) : ts.p.postData));*/
				switch(dt)
				{
				case "json":
				case "jsonp":
...
$.jgrid.extend({
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			var bt = "<table style='height:auto' class='EditTable ui-common-table' id='"+frmtborg+"_2'><tbody><tr><td colspan='2'>dddddd<hr class='"+commonstyle.content+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(rtlb ? bN+bP : bP+bN)+"</td><td class='EditButton'>"+bS+bC+"</td></tr>";
	...
	delGridRow : function(rowids,p) {
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				tbl += "<table class='EditTable ui-common-table' id='"+dtbl+"_2'><tbody><tr><td>qqqqqqqqqqqqqq<hr class='" + commonstyle.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+bS+"&#160;"+bC+"</td></tr></tbody></table>";
				p.gbox = "#gbox_"+$.jgrid.jqID(gID);
				...
				$("#dData","#"+dtbl+"_2").click(function(){
					...
					if(ret[0] && !rp_ge[$t.p.id].processing) {
						...
						//	contentType: rp_ge[$t.p.id].contentType,
							complete:function(data,status){
								var i;
